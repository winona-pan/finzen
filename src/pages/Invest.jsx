...
export default function InvestPage({ C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, confirm, TODAY,
  ...
  showHDP, setShowHDP, nS, setNS, nB, setNB, sortMode, setSortMode, visMode, setVisMode,
  nD, setND
}) {
  return (
    {tab} "invest" && (
