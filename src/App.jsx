...
export default function App() {
  ...
  return (
    <>
      ...
      <div style={{ maxWidth:480, margin:"0 auto", minHeight:"100dvh", background:C.bg, color:C.text, fontFamily:"'Noto Sans TC',system-ui,sans-serif", display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ flex:1, overflowY:"auto", paddingBottom:140, WebkitOverflowScrolling:"touch", paddingTop:"env(safe-area-inset-top, 44px)" }}>
          ...
          {tab === "overview" && <OverviewPage  {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    ...
    setSettleDebt, setEditDebt, setSelPool, selAcc, setSelAcc, recAmt, setRecAmt, doRecognize,
    setNAcc, payF, setPayF, setSelSub, setSelBill, setSelPolicy, setSelTxn, selTxn,
    nG, setNG, addGoal, editGoal, setEditGoal, nPL, setNPL, addPolicy, selPolicy, setSelPolicy,
    ...
    saveTxn, delTxn, adjBal, adjDesc, setAdjDesc, newBal, setNewBal, selAcc, setSelAcc,
    ...
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
          {tab === "wallet"   && <WalletPage    {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
          {tab === "charts"   && <ChartsPage    {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
          {tab === "notes"    && <NotesPage     {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
          {tab === "invest"   && <InvestPage    {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
          {tab === "settings" && <SettingsPage  {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />}
        ...
        <TxnModals    {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />
        <WalletModals {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />
        <StockModals  {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />
        <DebtModals   {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
    ...
    selPool, setSelPool, showGoalEP, setShowGoalEP, addCustomCE,
    C, tab, iSt, fmt, toTWD, pnlColor, upd, setModal, modal, close, confirm, TODAY} />
        <OtherModals  {accs, txns, debts, subs, bills, stocks, pools, cats, rates, goals, policies,
    stSum, stByAcc, stTotMv, stTotCost, visA, totAssets, netWorth, totDebt, totPay, totRec, cashBal,
    ceMap, CE, AT, PIE, moTxns, moInc, moExp, hTxns, hInc, hExp, subsMo, billsMo,
    chartData, chartRange, setChartRange, isSingleMo, allocPie, holdPie, invGrowth,
    incCat, expCat, chartView, setChartView, healthRange, setHealthRange,
